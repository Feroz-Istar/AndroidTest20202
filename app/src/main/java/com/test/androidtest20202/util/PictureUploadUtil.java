...
public class PictureUploadUtil {
    private static final int PERMISSION_REQUEST_CODE_CAMERA = 220;
    ...
    private void cameraIntent() {
        if(checkCameraPermission(context)){
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, Manifest.permission.CAMERA)) {
                ...
                alertBuilder.setMessage("Please allow Camera permission from settings.");
                ...
                ActivityCompat.requestPermissions((Activity) context, new String[]{Manifest.permission.CAMERA}, PERMISSION_REQUEST_CODE_CAMERA);
            }
        }
    }
    ...
    private boolean checkCameraPermission(final Context context) {
